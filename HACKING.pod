...
probably want L<https://guide.munin-monitoring.org/> instead.

You can find some additional contributing information at
L<https://guide.munin-monitoring.org/en/latest/others/index.html#contributing>.
...
The main development of Munin is happening on L<https://github.com>.

After registering an account you can report feature requests and issues
...
To install all the dependencies on a Debian based system:
...
Use this command to query the munin-node directly:
  ...
  ./dev_scripts/query_munin_node args ...

  ./dev_scripts/query_munin_node list
  ./dev_scripts/query_munin_node fetch *pluginname*
...
It ensures a correct invocation in relation to perl's taint mode.
  ...
  ./dev_scripts/run munin-node-configure --suggest
  ./dev_scripts/run munin-run *pluginname* [autoconf|config]
